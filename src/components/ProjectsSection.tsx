                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {projects.map((project, i) => (
                            <motion.div
                                ...
                                className="group p-5 rounded-lg border border-border bg-card/30 backdrop-blur-sm hover:border-primary/50 transition-all flex flex-col card-glow"
                            >
                                ...
                                <div className="flex flex-wrap gap-1.5 mt-auto">
                                    {project.tags.map((tag) => (
                                        <span
                                            key={tag}
                                            className="px-2 py-0.5 text-xs font-mono rounded bg-primary/5 border border-primary/10 text-primary/80"
                                        >
                                            {tag}
                                        </span>
                                    ))}
